...
// FrozenUTXO 冻结 UTXO（Script 为 hex）
...
// FetchFrozenTBCBalance 获取地址的冻结 TBC 余额
...
// fetchTBCLockTime 从 Piggy Bank 脚本解析锁定高度
// 脚本长度需为 106，锁时间在 chunks[len-8]
...
// FetchFrozenUTXOList 获取地址的冻结 UTXO 列表，并批量拉取每个 UTXO 的 script
...
// FetchUnfrozenUTXOList 获取已解冻的 UTXO 列表
