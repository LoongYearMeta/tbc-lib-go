...
// scriptHashFromHex sha256(hexDecode(script)) 然后反转
...
// FetchPoolNFTInfo 获取 Pool NFT 信息
...
// FetchPoolNFTUTXO 获取 Pool NFT UTXO
func FetchPoolNFTUTXO(contractTxID, network string) (*UTXO, error) {
...
// FetchFtLpUTXO 获取满足 amount 的 FT LP UTXO
