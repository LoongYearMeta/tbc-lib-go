...
// is first parsed form raw bytes and serialising the generated signature.
func Example_signMessage() {
	...
	// Serialise and display the signature.
	fmt.Printf("Serialised Signature: %x\n", signature.Serialise())
	...
	// Output:
	// Serialised Signature: 304402201008e236fa8cd0f25df4482dddbb622e8a8b26ef0ba731719458de3ccd93805b022032f8ebe514ba5f672466eba334639282616bb3c2f0ab09998037513d1f9e3d6d
...
func Example_verifySignature() {
	// Decode hex-encoded serialised public key.
	...
	// Decode hex-encoded serialised signature.
...
func Example_encryptMessage() {
	...
	plaintext, err := bec.Decrypt(privKey, ciphertext)
	if err != nil {
		fmt.Println(err)
		return
	}
