...
// SimpleUTXO 简化 UTXO 结构（Script 为 hex 字符串）
...
// FetchUMTXO 获取满足 tbcAmount 的 UMTXO
// scriptASM: ASM 格式的多签脚本
...
// FetchUMTXOs 获取 script 对应的所有 UMTXO
