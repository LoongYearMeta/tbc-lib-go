...
// NFTUTXO NFT UTXO（简化结构，Script 为 hex）
type NFTUTXO struct {
	TxID   string
	Vout   uint32
	Script string
...
// FetchNFTUTXO 获取 NFT UTXO，可选按 txHash 过滤
...
// FetchNFTUTXOs 获取指定 script+txHash 的所有 NFT UTXO
...
// FetchNFTs 获取 collection 下某 address 持有的 NFT 列表
